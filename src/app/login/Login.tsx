...
export const Login = () => {
  ...
  return (
    ...
    //             <h2 className="text-3xl  font-semibold flex justify-center items-center">Login</h2>

    //     <Label htmlFor="email" className="text-xl">Email</Label>
    //     <Input id="email" type="email" placeholder="Email" />
    //     <Label htmlFor="password" className="text-xl">Password</Label>
    //     <Input id="password" type="password" placeholder="Password" className="mb-2" />
    //     <Button variant="outline" className="text-xl">Sign In</Button>
    //     <Label htmlFor="email" className="text-sm">
    //       Dont have account? <Link href="/register" className="underline">Sign Up</Link>
    //     </Label>
    //   </div>
    // </div>
     ...
     <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="hidden md:flex z-10 w-1/2 max-w-2xl h-[600px] relative rounded-l-2xl overflow-hidden shadow-xl">
        <Image
          src="/property-hero.jpg" // Replace with your property image
          alt="Luxury property"
          fill
